...
(function() {
    ...
    app.service('DreamFactory', ['$http', function DreamFactory($http) {
        ...
        var app_name = "lesmots";

        var storageId = "lesmots";
        ...
        this.getFile = function(apiName, apiAction, filePath, callback) {
        ...
        this.replaceFile = function(apiName, apiAction, args, callback) {
            filePath = args.path;
